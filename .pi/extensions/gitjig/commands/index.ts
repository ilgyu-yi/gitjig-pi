 ...
 *
 * Four command implementations register here (`authoring-brief`, `review`,
 * `review-round`, `ship`). The `work-on` case answers no-no-yes and homes on the prompt-template
