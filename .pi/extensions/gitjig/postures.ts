...
export const POSTURES: readonly PostureRow[] = [
	...
	},
	{
		...
		posture: "closed",
		justification:
			"Recovery refuses before semantic dispatch. Restore one admitted private state domain or repair the existing permanently consumed record out of band; the runtime never falls back to clone-local or public/server exclusion and never resets an allowance.",
	},
	{
