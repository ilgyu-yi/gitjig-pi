...
export const POSTURES: readonly PostureRow[] = [
	...
	},
	{
		...
		failureShape:
			"the closed recovery profile set, materialized argv, installed executable grammar, attempt deadline, or independently admitted return is absent, malformed, expired, or unavailable",
		posture: "closed",
		justification:
