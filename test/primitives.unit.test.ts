	...
	it("declares exactly the shipped enforcement-layer rows, keyed on failure shape", () => {
		assert.deepEqual(
			...
			[
				...
				"adopter-provision-binding → closed",
				"adopter-provision-filesystem → closed",
				"adopter-provision-installed-pin → closed",
				"audit-append → open",
				...
				"empty-change-completion-derivation → closed",
				...
				"landing-policy-provenance → closed",
				"landing-policy-repository-binding → closed",
				"landing-policy-schema → closed",
				"landing-claim-write → closed",
				"landing-merge-outcome → closed",
				"landing-platform-snapshot → closed",
				"landing-quorum-ruleset → closed",
				"landing-topology-activation → closed",
				"landing-trusted-engine → closed",
				"lifecycle-clock-read → closed",
				"lifecycle-identity-read → closed",
				"lifecycle-label-mutation → closed",
				"lifecycle-platform-transport → closed",
				"lifecycle-record-population → closed",
				"lifecycle-record-write → closed",
				"lifecycle-repository-binding → closed",
				"lifecycle-shared-engine → closed",
				...
				"spec-absence → closed",
				"spec-absence → open",
				"topology-authorization-population → closed",
