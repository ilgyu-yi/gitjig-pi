 ...
 * The set was not chosen by reading the module: it is the survivor set of
 * 24 single-edit mutants run against it, and those survivors are what most
 * of the arms below
...
describe("§1.7 routing coverage — the refusal is live (issue #172)", () => {
	it("an unclaimed constituent is a routing failure naming exactly the unowned paths", () => {
		...
		// nothing.
		assert.ok(
			// The pin carries the affirmative framing and the
